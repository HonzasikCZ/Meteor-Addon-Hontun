package cz.honzasik.hontun.gui.screen.settings;
...
public class HontunEntityTypeListSettingScreen extends WindowScreen {
    ...
    public HontunEntityTypeListSettingScreen(HontunGuiTheme theme, EntityTypeListSetting setting) {
