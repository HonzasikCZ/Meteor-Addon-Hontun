...
public class WHontunDoubleEdit extends WVerticalList implements HontunWidget {
    ...
    public WHontunDoubleEdit(DoubleSetting setting) {
        this(setting.title,
            setting.description,
            setting,
            setting.get(),
    ...
    public WHontunDoubleEdit(String title, String description, DoubleSetting setting, double value, double min, double max, int decimalPlaces, double sliderMin, double sliderMax, boolean noSlider) {
        this.title = title;
    ...
    public void init() {
        ...
        textBox = (WHontunTextBox) list.add(theme().textBox(valueString(), this::filter, 0)).expandX().widget();
